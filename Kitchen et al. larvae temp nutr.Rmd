...
```{r temp plots, fig.height=5, fig.width=4, results='hide'}
...
```{r survivorship figure, results='hide'}
...
l.long.surv=ggplot(l.long_surv)+ aes(Duration,avg,color=Nutrient.Treatment, linetype=Heat.Treatment)+
  ...
  guides(col=guide_legend(ncol=2))+
  scale_colour_manual(name="Nutrients", values=c("mediumseagreen","mediumorchid2","sky blue", "coral"))+
...
```{r respiration figure, fig.show='hold', fig.height=4, fig.width=7, results='hide'}
...
```{r symbiont counts, fig.show='hold', fig.height=4, fig.width=7, results='hide'}
#############################################################################
...
counts.row=plot_grid(p.counts.graph, m.counts.graph, labels = c("a","b"), align = "h", nrow=1, label_size = 10) +
  draw_figure_label(label, position = "bottom", size = 10, fontface="bold")
...
```{r larval size figure, fig.height=4, fig.width=8.5, results='hide'}
##############################################################################################
