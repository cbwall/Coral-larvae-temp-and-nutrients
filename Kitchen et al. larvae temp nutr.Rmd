...
author: "Chris B Wall, with RM Kitchen, M Piscetta"
email: "cbwall@hawaii.edu"
date: "2/10/2020"
output:
  html_document:
    code_folding: hide
...
```
*Kitchen RM, Piscetta M, Lenz EA, de Souza MR, Schar D, Gates RD, Wall CB. Symbiont transmission and reproductive mode influence responses of three Hawaiian coral larvae to elevated temperature and nutrients. (2020) Coral Reefs*
...
c.resp.graph
dev.copy(pdf, "figures/combined.resp.pdf", width = 7, height = 4)
dev.off()
```
...
counts.graph
dev.copy(pdf, "figures/combined.symbiont.counts.pdf", width = 8, height = 4)
dev.off()
```
...
dev.copy(pdf, "figures/combined.size.pdf", width = 8, height = 4)
dev.off()
